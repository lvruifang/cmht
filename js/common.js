$(function(){
    ...
    $("#person3_checkbox_ctr1_show").click(function(){
    ...
    $("#zhibo_checkbox_ctrl_show").click(function(){
        ...
        $("#shipin_checkbox_box").find("input:checkbox").attr("checked",false);
        $("#dianbo_checkbox_box").find("input:checkbox").attr("checked",false);
    });
    //新建广告组页面点击视频显示视频的下拉内容
     $("#shipin_checkbox_ctr2_show").click(function(){
    	...
    	$("#dianbo_checkbox_box").hide();
        $("#zhibo_checkbox_box").find("input:checkbox").attr("checked",false);
        $("#dianbo_checkbox_box").find("input:checkbox").attr("checked",false);
    });
    ...
    $(".list-group-item  input:checkbox").click(function(){
        if(!$(this).is(":checked")){
            $(this).parent().siblings('label').find(".groupCkQuanX1").attr("checked",false);
        }
    })
